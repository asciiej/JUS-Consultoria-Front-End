...
class telaPrincipalAdm(ctk.CTkFrame):
    ...
    def choose_contract(self,tipoContrato,tituloContrato):
        self.unbind("<Configure>")
        for widget in self.winfo_children():
            widget.destroy()
        self.parent.show_frame("telaEdicaoContrato")
        self.parent.frames["telaEdicaoContrato"].show_contentEDICAO(tipoContrato, tituloContrato)
    ...
    def show_contentADM(self):
        ...
        self.buttonAlterarAcesso = ctk.CTkButton(self.body_frame,text="Alterar nível de acesso de usuário",command=self.alterarNivelAcesso,width=400,height=50)
        self.buttonAlterarAcesso.pack(side=ctk.TOP, pady=(80 ,20))
        ...
        #Frame
        self.frame_consultoria_empresarial = ctk.CTkScrollableFrame(self.body_frame, height=280, width=900, **frameCustom)
    ...
    #Quarta linha
        ...
        #Frame
        self.frame_consultoria_tributaria = ctk.CTkFrame(self.body_frame, height=280, width=950, **frameCustom)
        ...
        self.h2_1_1.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_1 = ctk.CTkButton(self.square1_1, text="Edite", command=partial(self.choose_contract,"Consultoria Tributária","Parecer Tributário"), **botao)
        self.button1_1.pack(side=ctk.BOTTOM, pady=(0, 45))
        ...
        self.h2_1_2.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_2 = ctk.CTkButton(self.square1_2, text="Edite", command=partial(self.choose_contract,"Consultoria Tributária","Planejamento Tributário"), **botao)
        self.button1_2.pack(side=ctk.BOTTOM, pady=(0, 45))
        ...
        self.h2_1_3.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_3 = ctk.CTkButton(self.square1_3, text="Edite", command=partial(self.choose_contract,"Consultoria Tributária","Contrato Editável Tributária"), **botao)
        self.button1_3.pack(side=ctk.BOTTOM, pady=(0, 45))
        ...
        #Frame
        self.frame_camara_arbitragem = ctk.CTkFrame(self.body_frame, height=280, width=950, **frameCustom)
        ...
        self.h2_1_1.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_1 = ctk.CTkButton(self.square1_1, text="Edite", command=partial(self.choose_contract,"Câmara de Arbitragem","Arbitragem Empresarial"), **botao)
        self.button1_1.pack(side=ctk.BOTTOM, pady=(0, 45))
        ...
        self.h2_1_2.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_2 = ctk.CTkButton(self.square1_2, text="Edite", command=partial(self.choose_contract,"Câmara de Arbitragem","Arbitragem Tributária"), **botao)
        self.button1_2.pack(side=ctk.BOTTOM, pady=(0, 45))
        ...
        self.h2_1_3.pack(side=ctk.TOP, pady=(12, 0))
        #Botão
        self.button1_3 = ctk.CTkButton(self.square1_3, text="Edite", command=partial(self.choose_contract,"Câmara de Arbitragem","Contrato Editável Arbitragem"), **botao)
        self.button1_3.pack(side=ctk.BOTTOM, pady=(0, 45))
